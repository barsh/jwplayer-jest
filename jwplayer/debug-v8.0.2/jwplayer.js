...
var _playerutils = __webpack_require__(/*! utils/playerutils */ 18);

var playerutils = _interopRequireWildcard(_playerutils);

var _validator = __webpack_require__(/*! utils/validator */ 14);
...
var _trycatch = __webpack_require__(/*! utils/trycatch */ 57);
...
var _ajax = __webpack_require__(/*! utils/ajax */ 58);
...
PromisePolyfill._immediateFn = typeof setImmediateFunc === 'function' && function (fn) {
    setImmediateFunc(fn);
} || function (fn) {
    setTimeoutFunc(fn, 0);
};
...
var Promise = window.Promise || (window.Promise = PromisePolyfill);
...
var _item = __webpack_require__(/*! playlist/item */ 20);

var _item2 = _interopRequireDefault(_item);

var _providersSupported = __webpack_require__(/*! providers/providers-supported */ 13);

var _providersSupported2 = _interopRequireDefault(_providersSupported);

var _providersRegister = __webpack_require__(/*! providers/providers-register */ 19);
...
function loadControlsPolyfillHtml5Bundle() {
    ...
    return __webpack_require__.e/* require.ensure */(0/*! jwplayer.core.controls.polyfills.html5 */).then((function (require) {
        ...
        (0, _providersRegister2.default)(__webpack_require__(/*! providers/html5 */ 9).default);
        return CoreMixin;
...
function loadIntersectionObserverIfNeeded() {
    if (requiresPolyfills()) {
        return __webpack_require__.e/* require.ensure */(7/*! polyfills.intersection-observer */).then((function (require) {
            return __webpack_require__(/*! intersection-observer */ 8);
        }).bind(null, __webpack_require__)).catch(chunkLoadErrorHandler);
    }
...
var _video = __webpack_require__(/*! utils/video */ 49);
...
var version = exports.version = '8.0.2+local.2017-11-21-13-28-28-848';
...
var _clock = __webpack_require__(/*! utils/clock */ 56);
...
var _providersLoaded = __webpack_require__(/*! providers/providers-loaded */ 28);
...
var _source = __webpack_require__(/*! playlist/source */ 29);

var _source2 = _interopRequireDefault(_source);

var _track = __webpack_require__(/*! playlist/track */ 55);
...
var _browserVersion = __webpack_require__(/*! ./browser-version */ 47);

var _osVersion = __webpack_require__(/*! ./os-version */ 48);
...
var _preload = __webpack_require__(/*! ./preload */ 54);
...
var Loaders = exports.Loaders = {
    html5: function html5() {
        return __webpack_require__.e/* require.ensure */(6/*! provider.html5 */).then((function (require) {
            var provider = __webpack_require__(/*! providers/html5 */ 9).default;
...
_extends(Providers.prototype, {
    ...
    load: function load(providersToLoad) {
        return Promise.all(providersToLoad.filter(function (provider) {
            return !!Loaders[provider.name];
        }).map(function (provider) {
            // Resolve event for unknown registered providers
            var providerLoaderMethod = Loaders[provider.name];
    ...
    required: function required(playlist) {
        var _this = this;

        playlist = playlist.slice();
        return _providersSupported2.default.filter(function (provider) {
...
var _loader = __webpack_require__(/*! plugins/loader */ 63);

var _loader2 = _interopRequireDefault(_loader);

var _model = __webpack_require__(/*! plugins/model */ 64);
...
exports.loadProvidersForPlaylist = loadProvidersForPlaylist;

var _playlist = __webpack_require__(/*! playlist/playlist */ 26);

var setPlaylist = function setPlaylist(model, playlist) {
    var feedData = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    var filteredPlaylist = (0, _playlist.filterPlaylist)(playlist, model, feedData);
...
function loadProvidersForPlaylist(model) {
    var playlist = model.get('playlist');
    var providersManager = model.getProviders();
...
var _error = __webpack_require__(/*! templates/error */ 59);
...
var _config = __webpack_require__(/*! api/config */ 51);

var _config2 = _interopRequireDefault(_config);

var _Setup = __webpack_require__(/*! api/Setup */ 52);
...
var _plugins = __webpack_require__(/*! plugins/plugins */ 31);
...
var _storage = __webpack_require__(/*! model/storage */ 66);
...
var CoreShim = function CoreShim(originalContainer) {
    ...
    'setConfig', 'setCurrentAudioTrack', 'setCurrentCaptions', 'setCurrentQuality', 'setFullscreen', 'addButton', 'removeButton', 'castToggle', 'setMute', 'setVolume', 'setPlaybackRate',

    // These commands require the view instance to be available
    'resize', 'setCaptions', 'setControls', 'setCues'], function () {
        return true;
    });
};
...
_extends(CoreShim.prototype, {
    ...
    init: function init(options, api) {
        ...
        var configuration = (0, _config2.default)(options, persisted);
        ...
        var mediaElement = model.attributes.mediaElement = (0, _getMediaElement2.default)(this.originalContainer);
        mediaElement.load();

        return _promise2.default.all([(0, _coreLoader2.default)(model), this.setup.start(), (0, _plugins2.default)(model, api)]).then(function (allPromises) {
            ...
            _this.setup(config, api, _this.originalContainer, _this._events, commandQueue);
    ...
    getConfig: function getConfig() {
        return _extends({}, this.modelShim.attributes);
    },
...
function ApiQueueDecorator(instance, queuedCommands, predicate) {
    ...
    this.destroy = function () {
        commandQueue.forEach(function (_ref) {
...
var _rssparser = __webpack_require__(/*! parsers/rssparser */ 60);
...
exports.INITIAL_PLAYER_STATE = undefined;
...
/* 42 */
/*!*****************************************!*\
  !*** ./src/js/api/get-media-element.js ***!
  \*****************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = getMediaElement;
function getMediaElement(parent) {
...
var _globalApi = __webpack_require__(/*! api/global-api */ 46);

var _globalApi2 = _interopRequireDefault(_globalApi);

var _version = __webpack_require__(/*! ./version */ 16);

var _api = __webpack_require__(/*! api/api */ 50);

var _api2 = _interopRequireDefault(_api);

var _apiSettings = __webpack_require__(/*! api/api-settings */ 15);
...
var jwplayer = function jwplayer(query) {
    ...
    // invalid query
    return {
        registerPlugin: _globalApi2.default.registerPlugin
    };
};
...
var _players = __webpack_require__(/*! ./players */ 24);

var _players2 = _interopRequireDefault(_players);

var _coreShim = __webpack_require__(/*! ./core-shim */ 36);
...
function _deserialize(options) {
    _underscore2.default.each(options, function (val, key) {
        options[key] = (0, _parser.serialize)(val);
    });
}
...
var Config = function Config(options, persisted) {
    ...
    if (!configPlaylist) {
        ...
        var obj = _underscore2.default.pick(config, ['title', 'description', 'type', 'mediaid', 'image', 'file', 'sources', 'tracks', 'preload']);
...
var _setupSteps = __webpack_require__(/*! api/setup-steps */ 53);
...
var Setup = function Setup(_model) {
    ...
    this.start = function () {
        var setupPromise = (0, _setupSteps2.default)(_model);
...
var _scriptloader = __webpack_require__(/*! utils/scriptloader */ 30);
...
function loadPlaylist(_model) {
    ...
    if (typeof playlist === 'string') {
        return new _promise2.default(function (resolve) {
            ...
            playlistLoader.on(_events.PLAYLIST_LOADED, function (data) {
                var loadedPlaylist = (0, _playlist2.default)(data.playlist);
    ...
    _model.attributes.playlist = (0, _playlist2.default)(playlist);
    return _promise.resolved;
}
...
function filterPlaylist(_model) {
    return loadPlaylist(_model).then(function () {
        ...
        (0, _setPlaylist2.default)(_model, _model.get('playlist'), _model.get('feedData'));
        ...
        var firstProviderNeeded = providersManager.required([playlist[0]]);
        // Skip provider loading if included in bundle
        if (_coreLoader.bundleContainsProviders.html5 && firstProviderNeeded && firstProviderNeeded[0].name === 'html5') {
            return;
        }
...
var startSetup = function startSetup(_model) {
    ...
    return _promise2.default.all([filterPlaylist(_model), loadSkin(_model)]);
};
...
var _mediaparser = __webpack_require__(/*! parsers/mediaparser */ 61);

var _mediaparser2 = _interopRequireDefault(_mediaparser);

var _jwparser = __webpack_require__(/*! parsers/jwparser */ 62);
...
var _plugin = __webpack_require__(/*! plugins/plugin */ 65);
...
/***/ })
/******/ ])["default"];
//# sourceMappingURL=jwplayer.700ef7800064d1e909f1.map